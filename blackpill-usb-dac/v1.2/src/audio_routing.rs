...
pub struct I2sResources<'d> {
    pub i2s: Peri<'static, peripherals::SPI2>,

    pub ck: Peri<'static, peripherals::PB10>,
    pub sd: Peri<'static, peripherals::PB15>,
    pub ws: Peri<'static, peripherals::PB12>,
    pub dma: Peri<'static, peripherals::DMA1_CH4>,
