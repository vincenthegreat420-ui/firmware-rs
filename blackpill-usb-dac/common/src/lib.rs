//! Common code for Black Pill USB DAC firmware.
//!
//! Provides USB audio class 1.0 implementation shared across
//! different Black Pill hardware versions.
#![no_std]
#![warn(missing_docs)]
